...
public class SignupActivity extends AppCompatActivity {
    ...
    private void createUser() {
        ...
        }else if (!(binding.driverRadio.isChecked() || binding.userRadio.isChecked())){
            Toast.makeText(getApplicationContext(), "Please select one of the 2 options", Toast.LENGTH_SHORT).show();
        }else{
            createUserInDB();
        }
    ...
    private void createUserInDB() {
        ...
        String type  ="";
        if (binding.userRadio.isChecked()){
            type = "user";
        }else{
            type = "driver";
        }
